...
#define	ST7735_CS_PIN		18			// <= /CS pin (chip-select, LOW to get attention of ST7735, HIGH and it ignores SPI bus)
#define	ST7735_DC_PIN		19			// <= DC pin (1=data or 0=command indicator line) also called RS
